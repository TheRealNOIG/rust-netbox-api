...
impl ImageAttachment {
    ...
    pub fn new(id: i32, url: String, display: String, content_type: String, object_id: i64, parent: Option<serde_json::Value>, image: String, image_height: i32, image_width: i32, created: Option<String>, last_updated: Option<String>) -> ImageAttachment {
        ImageAttachment {
            id,
            url,
            display,

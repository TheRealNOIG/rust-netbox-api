...
impl VlanGroup {
    ...
    pub fn new(id: i32, url: String, display: String, name: String, slug: String, scope: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, vlan_count: i32, utilization: String) -> VlanGroup {
        VlanGroup {
            id,
            url,
            display,

...
impl Job {
    pub fn new(id: i32, url: String, display: String, object_type: String, name: String, status: crate::models::JobStatus, created: String, user: crate::models::NestedUser, error: String, job_id: uuid::Uuid) -> Job {
        Job {
            id,
            url,
            display,

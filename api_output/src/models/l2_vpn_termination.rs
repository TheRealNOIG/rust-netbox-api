...
impl L2VpnTermination {
    ...
    pub fn new(id: i32, url: String, display: String, l2vpn: crate::models::NestedL2Vpn, assigned_object_type: String, assigned_object_id: i64, assigned_object: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> L2VpnTermination {
        L2VpnTermination {
            id,
            url,
            display,

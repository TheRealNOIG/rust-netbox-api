...
impl InventoryItem {
    ...
    pub fn new(id: i32, url: String, display: String, device: crate::models::NestedDevice, name: String, component: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, _depth: i32) -> InventoryItem {
        InventoryItem {
            id,
            url,
            display,

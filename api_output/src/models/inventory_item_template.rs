...
impl InventoryItemTemplate {
    ...
    pub fn new(id: i32, url: String, display: String, device_type: crate::models::NestedDeviceType, name: String, component: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, _depth: i32) -> InventoryItemTemplate {

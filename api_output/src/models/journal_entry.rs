...
impl JournalEntry {
    ...
    pub fn new(id: i32, url: String, display: String, assigned_object_type: String, assigned_object_id: i64, assigned_object: Option<serde_json::Value>, created: Option<String>, comments: String, last_updated: Option<String>) -> JournalEntry {
        JournalEntry {
            id,
            url,
            display,

...
impl FhrpGroupAssignment {
    ...
    pub fn new(id: i32, url: String, display: String, group: crate::models::NestedFhrpGroup, interface_type: String, interface_id: i64, interface: Option<serde_json::Value>, priority: i32, created: Option<String>, last_updated: Option<String>) -> FhrpGroupAssignment {
        FhrpGroupAssignment {
            id,
            url,
            display,

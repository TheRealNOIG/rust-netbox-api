...
impl IkeProposalRequest {
    ...
    pub fn new(name: String, authentication_method: AuthenticationMethod, encryption_algorithm: EncryptionAlgorithm, authentication_algorithm: AuthenticationAlgorithm, group: Group) -> IkeProposalRequest {
        IkeProposalRequest {
            name,
            description: None,

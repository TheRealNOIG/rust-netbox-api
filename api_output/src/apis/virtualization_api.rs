...
pub async fn virtualization_virtual_disks_create(configuration: &configuration::Configuration, writable_virtual_disk_request: crate::models::WritableVirtualDiskRequest) -> Result<crate::models::VirtualDisk, Error<VirtualizationVirtualDisksCreateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&writable_virtual_disk_request);
...
pub async fn virtualization_virtual_disks_partial_update(configuration: &configuration::Configuration, id: i32, patched_writable_virtual_disk_request: Option<crate::models::PatchedWritableVirtualDiskRequest>) -> Result<crate::models::VirtualDisk, Error<VirtualizationVirtualDisksPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_writable_virtual_disk_request);
...
pub async fn virtualization_virtual_disks_update(configuration: &configuration::Configuration, id: i32, writable_virtual_disk_request: crate::models::WritableVirtualDiskRequest) -> Result<crate::models::VirtualDisk, Error<VirtualizationVirtualDisksUpdateError>> {
    let local_var_configuration = configuration;

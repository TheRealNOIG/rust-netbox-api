...
/// struct for typed errors of method [`extras_event_rules_bulk_destroy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesBulkDestroyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_bulk_partial_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesBulkPartialUpdateError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_bulk_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesBulkUpdateError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesCreateError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_destroy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesDestroyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_partial_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesPartialUpdateError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesRetrieveError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`extras_event_rules_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExtrasEventRulesUpdateError {
    UnknownValue(serde_json::Value),
}
...
pub async fn extras_custom_fields_list(configuration: &configuration::Configuration, choice_set: Option<Vec<String>>, choice_set__n: Option<Vec<String>>, choice_set_id: Option<Vec<i32>>, choice_set_id__n: Option<Vec<i32>>, content_type_id: Option<Vec<i32>>, content_type_id__empty: Option<Vec<i32>>, content_type_id__gt: Option<Vec<i32>>, content_type_id__gte: Option<Vec<i32>>, content_type_id__lt: Option<Vec<i32>>, content_type_id__lte: Option<Vec<i32>>, content_type_id__n: Option<Vec<i32>>, content_types: Option<&str>, content_types__ic: Option<&str>, content_types__ie: Option<&str>, content_types__iew: Option<&str>, content_types__isw: Option<&str>, content_types__n: Option<&str>, content_types__nic: Option<&str>, content_types__nie: Option<&str>, content_types__niew: Option<&str>, content_types__nisw: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, filter_logic: Option<&str>, filter_logic__n: Option<&str>, group_name: Option<Vec<String>>, group_name__empty: Option<bool>, group_name__ic: Option<Vec<String>>, group_name__ie: Option<Vec<String>>, group_name__iew: Option<Vec<String>>, group_name__isw: Option<Vec<String>>, group_name__n: Option<Vec<String>>, group_name__nic: Option<Vec<String>>, group_name__nie: Option<Vec<String>>, group_name__niew: Option<Vec<String>>, group_name__nisw: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, is_cloneable: Option<bool>, limit: Option<i32>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, required: Option<bool>, search_weight: Option<Vec<i32>>, search_weight__empty: Option<bool>, search_weight__gt: Option<Vec<i32>>, search_weight__gte: Option<Vec<i32>>, search_weight__lt: Option<Vec<i32>>, search_weight__lte: Option<Vec<i32>>, search_weight__n: Option<Vec<i32>>, r#type: Option<Vec<String>>, type__n: Option<Vec<String>>, ui_editable: Option<&str>, ui_editable__n: Option<&str>, ui_visible: Option<&str>, ui_visible__n: Option<&str>, weight: Option<Vec<i32>>, weight__empty: Option<bool>, weight__gt: Option<Vec<i32>>, weight__gte: Option<Vec<i32>>, weight__lt: Option<Vec<i32>>, weight__lte: Option<Vec<i32>>, weight__n: Option<Vec<i32>>) -> Result<crate::models::PaginatedCustomFieldList, Error<ExtrasCustomFieldsListError>> {
    ...
    if let Some(ref local_var_str) = ui_editable {
        local_var_req_builder = local_var_req_builder.query(&[("ui_editable", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = ui_editable__n {
        local_var_req_builder = local_var_req_builder.query(&[("ui_editable__n", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = ui_visible {
        local_var_req_builder = local_var_req_builder.query(&[("ui_visible", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = ui_visible__n {
        local_var_req_builder = local_var_req_builder.query(&[("ui_visible__n", &local_var_str.to_string())]);
    }
...
pub async fn extras_event_rules_bulk_destroy(configuration: &configuration::Configuration, event_rule_request: Vec<crate::models::EventRuleRequest>) -> Result<(), Error<ExtrasEventRulesBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/extras/event-rules/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&event_rule_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_bulk_partial_update(configuration: &configuration::Configuration, event_rule_request: Vec<crate::models::EventRuleRequest>) -> Result<Vec<crate::models::EventRule>, Error<ExtrasEventRulesBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_bulk_update(configuration: &configuration::Configuration, event_rule_request: Vec<crate::models::EventRuleRequest>) -> Result<Vec<crate::models::EventRule>, Error<ExtrasEventRulesBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_create(configuration: &configuration::Configuration, writable_event_rule_request: crate::models::WritableEventRuleRequest) -> Result<crate::models::EventRule, Error<ExtrasEventRulesCreateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&writable_event_rule_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<ExtrasEventRulesDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/extras/event-rules/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_list(configuration: &configuration::Configuration, action_object_id: Option<Vec<i32>>, action_object_id__empty: Option<Vec<i32>>, action_object_id__gt: Option<Vec<i32>>, action_object_id__gte: Option<Vec<i32>>, action_object_id__lt: Option<Vec<i32>>, action_object_id__lte: Option<Vec<i32>>, action_object_id__n: Option<Vec<i32>>, action_object_type: Option<&str>, action_object_type__n: Option<&str>, action_type: Option<Vec<String>>, action_type__n: Option<Vec<String>>, content_type_id: Option<Vec<i32>>, content_type_id__empty: Option<Vec<i32>>, content_type_id__gt: Option<Vec<i32>>, content_type_id__gte: Option<Vec<i32>>, content_type_id__lt: Option<Vec<i32>>, content_type_id__lte: Option<Vec<i32>>, content_type_id__n: Option<Vec<i32>>, content_types: Option<&str>, content_types__ic: Option<&str>, content_types__ie: Option<&str>, content_types__iew: Option<&str>, content_types__isw: Option<&str>, content_types__n: Option<&str>, content_types__nic: Option<&str>, content_types__nie: Option<&str>, content_types__niew: Option<&str>, content_types__nisw: Option<&str>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, enabled: Option<bool>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, type_create: Option<bool>, type_delete: Option<bool>, type_job_end: Option<bool>, type_job_start: Option<bool>, type_update: Option<bool>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedEventRuleList, Error<ExtrasEventRulesListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = action_object_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__empty {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__empty".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__empty", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__gt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__gt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__gte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__gte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__lt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__lt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__lte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__lte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_object_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_object_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_object_type {
        local_var_req_builder = local_var_req_builder.query(&[("action_object_type", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = action_object_type__n {
        local_var_req_builder = local_var_req_builder.query(&[("action_object_type__n", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = action_type {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_type".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_type", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = action_type__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("action_type__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("action_type__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = content_type_id {
        local_var_req_builder = match "multi" {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_partial_update(configuration: &configuration::Configuration, id: i32, patched_writable_event_rule_request: Option<crate::models::PatchedWritableEventRuleRequest>) -> Result<crate::models::EventRule, Error<ExtrasEventRulesPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_writable_event_rule_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::EventRule, Error<ExtrasEventRulesRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn extras_event_rules_update(configuration: &configuration::Configuration, id: i32, writable_event_rule_request: crate::models::WritableEventRuleRequest) -> Result<crate::models::EventRule, Error<ExtrasEventRulesUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtrasEventRulesUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
